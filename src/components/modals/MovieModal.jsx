...
export default function MovieModal() {
  ...
  const getMovie = async () => {
    try {
      if (movieID) {
        ...
        setPreviewImageURL(response.movies.thumbnail);
        setSelectedCountry(response.movies.countryID);
        setRelease(dayjs(response.movies.release, "YYYY-MM-DD"));
        setPreviewBackground(response.movies.background);
      }
    } catch (error) {
      console.error("Lỗi khi gọi API:", error);
    }
  ...
  const handleChangePoster = async (e) => {
    let data = e.target.files;
    let file = data[0];
    if (file) {
      const base64 = await commonUtils.getBase64(file);
      const objectURL = URL.createObjectURL(file);
      setPreviewBackground(base64);
      setMovieState((prevState) => ({
        ...prevState,
        background: base64,
      }));
  ...
  const handleChangeReleaseDate = (value) => {
    const releaseDate = value.format("YYYY-MM-DD");
    console.log(releaseDate);
    setRelease(dayjs(value, "YYYY-MM-DD"));
    setMovieState((prevState) => ({
      ...prevState,
      release: releaseDate,
    }));
    ...
    <div className="fixed inset-0 z-10">
      ...
      <div className="absolute w-7/12 h-[90%] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white rounded">
        <div className="p-4 flex justify-start flex-col items-start ">
          ...
          <form className="w-[60%] flex gap-5 pl-9" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="flex gap-10">
                ...
                <div>
                  <Typography className="text-[14px]">Release</Typography>
                  <DatePicker
              ...
              <div className="mb-4 flex">
                ...
                <div>
                  <Typography className="text-[14px]">Actor</Typography>
                  <Select
                    showSearch
                    mode="tags"
                    size={size}
            ...
            <div className="absolute top-10 right-10 flex flex-col items-center">
              <div className="mb-2">
                ...
                <div className="flex gap-4 items-center flex-col">
                  ...
                  <label htmlFor="previewImg" className="cursor-pointer">
                    <div className="flex w-[200px] justify-center items-center gap-3 h-9 border border-gray-300 rounded-md px-5 hover:border-blue-500 hover:shadow-md transition duration-300 py-5">
                      <svg
              ...
              <div className="mb-2">
                <Typography className="text-[14px]">Poster</Typography>
                <div className="flex gap-4 items-center flex-col">
                  <div className="border border-gray-300 rounded-md flex items-center">
                    <Image
                      width={200}
                      height={230}
                      src={previewBackground || "error"}
                      className="rounded-md "
                      fallback="data:image/png;base64,"
                    />
                  </div>
                  ...
                  />
                  <label htmlFor="previewPoster" className="cursor-pointer">
                    <div className="flex w-[200px] justify-center items-center gap-3 h-9 border border-gray-300 rounded-md px-5 hover:border-blue-500 hover:shadow-md transition duration-300 py-5">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
